    ...
    <div className="lgs_container">
      <div className="lgs_form" onSubmit={handleSubmit}>
        <form className="content">
          ...
          <div className="inputs">
            ...
            {/* <textarea
              ...
              cols="30"
              rows="5"
              placeholder="Please Describe Your Development Needs. (E-commerce website, Booking Site, Portfolio, Mobile App, etc...)."
              onChange={handleInputChange}
        ...
        <div className="contact_information">
          <>
            <strong>
              <ImLocation /> Located in NYC
            </strong>
            <a href="tel:6463522512">
              <BsFillTelephoneFill /> 646-352-2512
            </a>
          </>
        </div>
      </div>
