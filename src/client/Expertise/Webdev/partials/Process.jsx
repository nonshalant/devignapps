    ...
    <div className="process_container">
      <div className="step step_container">
        ...
        <p>
          ...
          towards transforming your business.
        </p>
        <p>
          To proceed to the next phase of this process a retainer of{" "}
          <span className="retainer_price">250-500</span> is required.{" "}
        </p>
      </div>
        ...
        {webDevImages.map(
          (image) =>
            image.id === "working" && (
              <div
                key={image.cloudName}
                className="consultaion_image_container"
              >
                <Image cloudName={image.cloudName} publicId={image.image} />
              </div>
            )
      ...
      <div className="step step_container">
        ...
        <p>
          ...
          final payment of <span className="retainer_price">250-500</span>.{" "}
        </p>
      </div>
    </div>
  );
